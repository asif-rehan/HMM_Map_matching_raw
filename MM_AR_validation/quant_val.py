...
if __name__ == "__main__":
	out_fldr = os.path.join(r'C:\Users\usm-dorne\Documents\MM_algo',
							r'HMM_Map_matching_raw-master\MM_AR_validation',
							r'val_dataset\val_dataset_output')
	src_fldr = os.path.join(r'C:\Users\usm-dorne\Documents\MM_algo',
							r'HMM_Map_matching_raw-master\MM_AR_validation',
							'val_dataset')
	...
	try:
		...
		#second_trial
		#============
		#sys.stdout = open(os.path.join(out_fldr, "sys.stdout2.txt"), 'w')
		#src_files = src_files[22:]
		#print quant_score(src_files, src_fldr, out_fldr, 
		#	des_freq_lst=[None])
        #Third_trial
		#============
		...
		sys.stdout = open(os.path.join(out_fldr, "sys.stdout3.txt"), 'w')
		print quant_score(src_files, src_fldr, out_fldr, 
			des_freq_lst=[10, None])
	finally:
		sys.stdout.close()
